...
const ProfilePage = () => {
    const { user, authenticated, getUser, getUserSubsctiptions } = useUserStore()
    ...
    }, [authenticated, getUser, router, getUserSubsctiptions])
                    ...
                    {user.updatedOn && (
                        <Col xs={24} sm={12} md={8}>
                            <div>
                                ...
                                <p style={{ margin: 0, color: '#0c4a6e', fontSize: '13px', fontFamily: 'monospace' }}>{user.updatedOn}</p>
                            </div>
                        </Col>
                    )}
                </Row>
